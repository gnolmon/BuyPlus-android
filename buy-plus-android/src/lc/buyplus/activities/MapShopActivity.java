...
import lc.buyplus.fragments.MapShopFragment;
import lc.buyplus.fragments.SettingTermFragment;

public class MapShopActivity extends CoreActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mFragmentManager.beginTransaction()
				.add(R.id.canvas, MapShopFragment.getInstance(MapShopActivity.this)).commit();
	}
