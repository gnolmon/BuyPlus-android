...
import lc.buyplus.fragments.UserCanvasFragment;

public class UserActivity  extends CoreActivity {
...
//	private ImageView image;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mFragmentManager.beginTransaction().add(R.id.canvas, UserCanvasFragment.getInstance(UserActivity.this,CanvasFragment.mUser)).commit();
	}
