...
import lc.buyplus.fragments.ProductListFragment;
import lc.buyplus.fragments.ProductShowFragment;
import lc.buyplus.fragments.SettingTermFragment;

public class ProductListActivity extends CoreActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mFragmentManager.beginTransaction()
				.add(R.id.canvas, ProductListFragment.getInstance(ProductListActivity.this)).commit();
	}
