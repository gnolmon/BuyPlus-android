...
public class HomeNotiActivity extends CoreActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mFragmentManager.beginTransaction().add(R.id.canvas, HomeNotiFragment.getInstance(HomeNotiActivity.this))
				.commit();
	}
