...
public class SdkCastPlayerActivity extends BaseCastPlayerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoadQueueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SdkCastPlayerActivity.this, QueueActivity.class);
                intent.putExtra(QueueActivity.EXTRA_ADAPTER_MODE, QueueItemAdapter.MODE_LOAD);
        ...
        mInsertQueueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SdkCastPlayerActivity.this, QueueActivity.class);
                intent.putExtra(QueueActivity.EXTRA_ADAPTER_MODE, QueueItemAdapter.MODE_INSERT);
                putExtraMediaStatus(mMediaPlayer.getMediaStatus(), intent);
        ...
        mUpdateQueueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SdkCastPlayerActivity.this, QueueActivity.class);
                intent.putExtra(QueueActivity.EXTRA_ADAPTER_MODE, QueueItemAdapter.MODE_UPDATE);
                putExtraMediaStatus(mMediaPlayer.getMediaStatus(), intent);
        ...
        mRemoveQueueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SdkCastPlayerActivity.this, QueueActivity.class);
                intent.putExtra(QueueActivity.EXTRA_ADAPTER_MODE, QueueItemAdapter.MODE_REMOVE);
                putExtraMediaStatus(mMediaPlayer.getMediaStatus(), intent);
        ...
        mQueueJumpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SdkCastPlayerActivity.this, QueueActivity.class);
                intent.putExtra(QueueActivity.EXTRA_ADAPTER_MODE, QueueItemAdapter.MODE_JUMP);
                putExtraMediaStatus(mMediaPlayer.getMediaStatus(), intent);
    ...
    private void putExtraMediaStatus(final MediaStatus mediaStatus, Intent intent) {
        ...
        intent.putExtra(QueueActivity.EXTRA_REPEAT_MODE, mediaStatus.getQueueRepeatMode());
        ...
        intent.putExtra(QueueActivity.EXTRA_ITEMS, itemStrings);
        intent.putExtra(QueueActivity.EXTRA_CURRENT_ITEM_ID, mediaStatus.getCurrentItemId());
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case RESULT_CODE_QUEUE_LOAD: {
                String[] jsonItems = data.getStringArrayExtra(QueueActivity.EXTRA_ITEMS);
                ...
                int repeatMode = data.getIntExtra(QueueActivity.EXTRA_REPEAT_MODE,
                        MediaStatus.REPEAT_MODE_REPEAT_ALL);
                int startIndex = data.getIntExtra(QueueActivity.EXTRA_START_INDEX, 0);
            ...
            case RESULT_CODE_QUEUE_INSERT: {
                ...
                mMediaPlayer.queueInsertItems(mApiClient, items, MediaQueueItem.INVALID_ITEM_ID, null)
                        .setResultCallback(new MediaResultCallback(
            ...
            case RESULT_CODE_QUEUE_REMOVE: {
                int[] itemIdsToRemove = data.getIntArrayExtra(QueueActivity.EXTRA_ITEM_IDS);
            ...
            case RESULT_CODE_QUEUE_JUMP: {
                int currentItemId = data.getIntExtra(QueueActivity.EXTRA_CURRENT_ITEM_ID, 0);
